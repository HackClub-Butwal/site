    ...
    <>
      ...
      <Container>
        ...
        >
          ...
          >
            <Heading as="h2" sx={{ fontSize: 2, mb: 2 }}>Looking for something specific?</Heading>
            <Text sx={{ fontSize: 1 }}>
              Try checking out our <Link href="/workshops" sx={{ color: 'primary' }}>Workshops</Link>, 
              <Link href="/community" sx={{ color: 'primary' }}> Community</Link>, or 
              <Link href="/gallery" sx={{ color: 'primary' }}> Gallery</Link> pages. 
              Or <Link href="/contact" sx={{ color: 'primary' }}>contact us</Link> if you need help finding something.
            </Text>
          </Box>
        </Flex>
      </Container>
