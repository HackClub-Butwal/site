...
function TierSection({ tier, sponsors, tierHeaderStyles }) {
  return (
...
function SponsorshipBenefitsSection() {
  return (
        ...
        {isLoading ? (
          ...
          <>
            {sponsorsByTier.map(({ tier, sponsors }) => (
              <TierSection key={tier} tier={tier} sponsors={sponsors} tierHeaderStyles={tierHeaderStyles} />
            ))}
          </>
        )}
